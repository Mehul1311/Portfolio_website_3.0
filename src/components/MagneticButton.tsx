    ...
    <a
      ...
      className={[
        ...
        isPrimary
          ...
          : 'border border-white/[0.12] bg-white/[0.03] text-zinc-200 shadow-none backdrop-blur-sm hover:border-cyan-400/35 hover:bg-white/[0.06] hover:text-white',
      ].join(' ')}
    >
      <span className={isPrimary ? 'text-neutral-950' : ''}>{children}</span>
      <span className={isPrimary ? 'text-neutral-800' : 'text-zinc-500 group-hover:text-cyan-400/90'}>↗</span>
    </a>
  )
}
